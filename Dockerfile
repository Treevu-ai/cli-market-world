...
COPY market_server.py market_mcp.py market_cli.py market_stores.py market_core.py server_deps.py pyproject.toml collect_prices.py market_spread.py market_units.py price_confidence.py dashboard_glossary.py dashboard_view_model.py ./
