...
export const FAQ_SCHEMA_ES = [
  ...
  {
    q: "¿Cuánto cuesta?",
    a: "La CLI es open source (MIT). Free: 1.000 consultas/día. Starter: USD 9/mes. Pro: USD 49/mes o USD 490/año. Pro Founding: USD 29/mes (100 plazas). Enterprise a medida.",
  },
];
...
export const FAQ_SCHEMA_EN = [
  ...
  },
  {
    ...
    a: "The CLI is open source (MIT). Free: 1,000 requests/day. Starter: USD 9/mo. Pro: USD 49/mo or USD 490/yr. Pro Founding: USD 29/mo (100 seats). Enterprise custom.",
  },
];
