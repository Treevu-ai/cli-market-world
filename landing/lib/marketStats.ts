...
export const MARKET_STATS = {
  ...
  seoDescription: "Commerce API for AI agents. 43 MCP tools, 60 retailers, 30 verified active. 8 countries. 39,000+ verified shelf prices refreshed every 8 hours. Normalized per kg/L, quality-filtered. pip install cli-market.",
