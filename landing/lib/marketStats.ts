...
export const MARKET_STATS = {
  ...
  seoDescription: "Commerce API for AI agents. 43 MCP tools, 66 retailers, 36 verified active. 8 countries. 45,000+ verified shelf prices refreshed every 4 hours. Normalized per kg/L, quality-filtered. pip install cli-market.",
  serverDescription: "Commerce for AI agents. 43 MCP tools. 66 retailers (36 verified), 8 countries, 3 platforms.",
} as const;
