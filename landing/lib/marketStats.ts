...
export const MARKET_STATS = {
  ...
  seoDescription: "Commerce API for AI agents. 43 MCP tools, 66 retailers, 66 verified active. 11 countries. 45,000+ verified shelf prices refreshed every 4 hours. Normalized per kg/L, quality-filtered. pip install cli-market.",
