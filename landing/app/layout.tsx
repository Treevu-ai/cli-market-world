  ...
  return (
    <html lang="es" className={`dark h-full ${GeistSans.variable}`}>
      ...
      >
        ...
        <a
          href="#main-content"
          className="sr-only focus:not-sr-only focus:fixed focus:top-4 focus:left-4 focus:z-[200] focus:rounded-lg focus:bg-[#3E6B4C] focus:px-4 focus:py-2 focus:text-white focus:text-sm focus:font-semibold"
        >
