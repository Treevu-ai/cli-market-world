      ...
      <div className="relative z-10 w-full max-w-[1200px] mx-auto px-6 lg:px-12 py-32 lg:py-40">
        <div className="lg:max-w-[65%]">
          ...
          <div className={`flex flex-col sm:flex-row gap-4 transition-all duration-700 delay-500 ${visible?"opacity-100 translate-y-0":"opacity-0 translate-y-4"}`}>
            ...
            <a href="https://github.com/Treevu-ai/cli-market-world" target="_blank" rel="noopener" className="inline-flex items-center">
              <img src="https://img.shields.io/github/stars/Treevu-ai/cli-market-world?style=social" alt="GitHub stars" className="h-[20px]" />
            </a>
            <a href="https://pypi.org/project/cli-market/" target="_blank" rel="noopener" className="inline-flex items-center">
              <img src="https://img.shields.io/pypi/dm/cli-market?style=social" alt="PyPI downloads" className="h-[20px]" />
            </a>
