...
const es: Dict = {
  ...
  hero_stats: "100 COMERCIOS · 12 LÍNEAS · 10 PAÍSES · 1 API UNIFICADA.",
  hero_sub: "UN PRODUCTO PENSADO PARA HUMANOS. DISEÑADO PARA AGENTES.",
  hero_cta: "INSTALAR AHORA", hero_cta2: "VER COMANDOS →",
  ribbon_header: "COBERTURA · 100 COMERCIOS · 12 LÍNEAS · 10 PAÍSES", ribbon_online: "ONLINE",
...
const en: Dict = {
  ...
  hero_stats: "100 RETAILERS · 12 LINES · 10 COUNTRIES · 1 UNIFIED API.",
  hero_sub: "A PRODUCT BUILT FOR HUMANS. DESIGNED FOR AGENTS.",
  hero_cta: "INSTALL NOW", hero_cta2: "SEE COMMANDS →",
  ribbon_header: "COVERAGE · 100 RETAILERS · 12 LINES · 10 COUNTRIES", ribbon_online: "ONLINE",
