  ...
  return (
    <section id="coverage" className="relative flex flex-col w-full bg-[#080808] py-16 px-6 lg:px-12 md:py-[80px] gap-8">
      ...
      <div className="flex gap-4 max-w-[1100px] flex-wrap">
        <div className="bg-[#0A0A0A] border border-[#1A1A1A] px-6 py-3 flex items-center gap-3"><span className="text-2xl font-grotesk font-bold text-white">3,760+</span><span className="text-[10px] font-mono text-[#555] uppercase tracking-wider">Comercios en 67 países</span></div>
