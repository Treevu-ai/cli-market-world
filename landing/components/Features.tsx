...
const categories: {
  ...
  { id: "shop", label_es: "Búsqueda & Compra", label_en: "Search & Purchase", tools: [
    { n: "market_search", d_es: "Buscar productos en 41 retailers", d_en: "Search products across 41 retailers" },
  ...
  { id: "platform", label_es: "Plataforma", label_en: "Platform", tools: [
    ...
    { n: "market_stores", d_es: "Listar 41 retailers verificados", d_en: "List 41 verified retailers" },
