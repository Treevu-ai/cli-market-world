...
const categories: Category[] = [
  ...
  },
  {
    ...
    tools: [
      ...
      { n: "market_stores",  d_es: "60 retailers verificados", d_en: "30 verified retailers", demo_es: "market_stores\n→ Wong 🇵🇪 · Carrefour 🇦🇷 · Motorola 🇧🇷 ...", demo_en: "market_stores\n→ Wong 🇵🇪 · Carrefour 🇦🇷 · Motorola 🇧🇷 ...", c: "#3cffd0" },
      { n: "market_countries", d_es: "11 países con cobertura", d_en: "11 countries covered", demo_es: "market_countries\n→ AR (8) · BR (7) · PE (4) · CO (3) ...", demo_en: "market_countries\n→ AR (8) · BR (7) · PE (4) · CO (3) ...", c: "#3cffd0" },
