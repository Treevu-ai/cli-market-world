        ...
        <section className="mb-16 scroll-mt-24" id="introduction">
          ...
          <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <div className="card-cyber header-strip p-6">
              ...
              <p className="font-mono text-lg text-white">{formatReqLimit(BUILD_TIER_FREE.reqLimit, isES, "short")}</p>
    ...
    {"store": "jumbo_ar", "name": "...", "price": 2050.0, "currency": "ARS"}
        ...
        <section className="mb-16 scroll-mt-24" id="limits">
          ...
          <ul className="text-sm text-[var(--cm-on-surface-variant)] space-y-3 list-none pl-0">
            <li>
              <strong className="text-white">Free</strong> — {formatReqLimit(BUILD_TIER_FREE.reqLimit, isES)} · 1{" "}
              {t("clave API (lectura)", "API key (read)")} · {MARKET_STATS.mcpTools} MCP · {t("historial 7 días", "7-day history")}
            </li>
            <li>
              <strong className="text-white">Starter</strong> — {formatReqLimit(BUILD_TIER_STARTER.reqLimit, isES)} ·{" "}
              {BUILD_TIER_STARTER.apiKeys} {t("clave API", "API key")} · export CSV · USD {BUILD_TIER_STARTER.priceUsd}/mo
            </li>
            <li>
              <strong className="text-white">Pro</strong> — {formatReqLimit(BUILD_TIER_PRO.reqLimit, isES)} ·{" "}
