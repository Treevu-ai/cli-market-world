  ...
  return (
    <section id="about" className="relative bg-[var(--wise-ink)] py-16">
      <div className="landing-container text-center">
        ...
        {/* Founder card — stacked layout so avatar never squeezes text sideways */}
        <div className="bg-[var(--wise-green-pale)] rounded-3xl p-6 sm:p-8 w-full max-w-sm mx-auto min-w-0 overflow-hidden">
          <div className="flex flex-col items-center gap-4 text-center">
            <img
              ...
              className="w-20 h-20 rounded-full object-cover shrink-0 ring-2 ring-white/80"
            />
            <div className="min-w-0 w-full space-y-1">
              <div className="inline-flex flex-wrap items-center justify-center gap-x-1.5 gap-y-1 max-w-full">
                <h3 className="text-lg font-bold text-[var(--wise-ink)] leading-tight">Ricardo Cuba</h3>
              ...
              <p className="text-sm text-[var(--wise-body)] leading-snug">
                Founder &amp; Product Owner
              </p>
              <p className="text-sm font-medium text-[var(--wise-ink)] leading-snug">
                CLI Market
              </p>
              <p className="pt-1 text-xs text-[var(--wise-body)] leading-relaxed">
                {isES ? "Gerente General" : "General Manager"}
                <br />
                <span className="text-[var(--wise-ink)]/80">SINAPSIS INNOVADORA S.A.C.</span>
              </p>
            </div>
          </div>

          <div className="mt-5 pt-4 border-t border-[#c5edab]/60 grid grid-cols-1 gap-2">
            <a
              href="https://instagram.com/cli.market"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex w-full items-center justify-center gap-2 rounded-full bg-white/60 px-4 py-2.5 text-xs font-medium text-[var(--wise-body)] hover:text-[var(--wise-ink)] hover:bg-white transition-colors"
            >
