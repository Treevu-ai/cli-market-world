...
export default function CommerceStackSection() {
  ...
  return (
    <section id="architecture" className="landing-section animate-fade-in scroll-mt-24" style={{ backgroundColor: "#ffffff" }}>
            ...
            <div key={i}>
              <div className="card-cyber rounded-2xl p-6 text-left">
                <div className="flex items-start gap-4">
                  <span className="w-8 h-8 rounded-full bg-[var(--cm-mint)] text-[#f8fafc] text-sm font-bold flex items-center justify-center shrink-0 mt-0.5">
                    {step.num}
                  </span>
                  <div>
