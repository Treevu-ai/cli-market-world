...
export default function UseCasesSection() {
  ...
  return (
    <section id="use-cases" className="landing-section landing-section-glow animate-fade-in">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 landing-content-rail text-left mb-12">
          {visibleCases.map((c, i) => (
            ...
            >
              ...
              <h3 className="text-sm font-bold text-[var(--cm-on-surface)]">{isES ? c.title_es : c.title_en}</h3>
