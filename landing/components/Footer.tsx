...
const coberturaES = ["30 retailers", "8 países", "6 líneas", "30 MCP tools", "API keys + scopes"];
const coberturaEN = ["30 retailers", "8 countries", "6 lines", "30 MCP tools", "API keys + scopes"];
const recursos = [
      ...
      <div className="flex flex-col md:flex-row gap-8 sm:gap-10 md:gap-[80px] px-4 sm:px-6 md:px-[120px] py-8 sm:py-10 md:py-[64px]">
        <div className="flex flex-col gap-4 md:w-[260px] md:shrink-0">
          ...
          <p className="font-mono text-[10px] text-[#666] leading-[1.6] max-w-[240px]">
            {lang === "es"
              ? "Infraestructura de comercio para agentes de IA. 30 retailers VTEX en 8 países. Una sola API."
              : "Commerce infrastructure for AI agents. 30 VTEX retailers in 8 countries. One API."}
          </p>
