...
const LAYERS = [
  { n: "01", es: "Ingestión", en: "Ingestion", descEs: `Scrapers nativos VTEX, Shopify, Magento y WooCommerce capturan precios de góndola cada 4 horas en ${MARKET_STATS.countries} países. Sin APIs de retailers — leemos lo que ve el comprador.`, descEn: `Native VTEX, Shopify, Magento, and WooCommerce scrapers capture shelf prices every 4 hours across ${MARKET_STATS.countries} countries. No retailer APIs — we read what the buyer sees.` },
