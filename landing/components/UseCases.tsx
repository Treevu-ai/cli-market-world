  ...
  return (
    <section id="usecases" className="relative flex flex-col w-full bg-black py-16 px-6 lg:px-12 md:py-[80px] gap-8">
      <div className="flex flex-col gap-3 max-w-[600px]">
        <span className="inline-flex items-center gap-3 text-sm font-mono text-white/40"><span className="w-8 h-px bg-[#00FF88]/40"/>{t("usecases_label")}</span>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-[900px]">
        {cases.map((c) => (
          <div key={c.tKey} className="bg-[#0A0A0A] border border-[#1A1A1A] p-6 flex flex-col gap-4">
