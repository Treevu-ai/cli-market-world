  ...
  return (
    <section ref={ref} id="terminal" className="relative flex flex-col w-full bg-black py-16 px-6 lg:px-12 md:py-[80px] gap-8">
      <div className="flex flex-col gap-3 max-w-[600px]">
        ...
        <p className="text-white/50 font-mono text-sm leading-relaxed">Instala, autenticate y empieza a buscar en 3,400+ retailers VTEX desde la terminal.</p>
      ...
      <p className="text-white/30 font-mono text-[10px] uppercase tracking-widest max-w-[800px]">OPEN SOURCE · MIT LICENSE · pip install · 3,400+ COMERCIOS · 67 PAISES</p>
    </section>
  );
}
