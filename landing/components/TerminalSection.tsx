...
const cells_es = [
  { title: "Search", lines: [
    ...
    { text: "▸ 3 resultados en 1.2s", color: "text-[#454745]", delay: 1500 },
  ]},
  { title: "Compare", lines: [
    ...
    { text: "▸ Ahorro: S/ 0.70 por unidad", color: "text-[#454745]", delay: 1300 },
  ]},
  { title: "Cart", lines: [
    { text: "$ market basket leche:2 arroz:1", delay: 300 },
    { text: "▸ Canasta comparada en 3 tiendas", color: "text-[#454745]", delay: 600 },
  ...
  { title: "Checkout", lines: [
    ...
    { text: "▸ QR Yape generado", color: "text-[#454745]", delay: 900 },
    { text: "▸ Escanea para completar el pago", color: "text-[#454745]", delay: 1100 },
  ]},
];
...
const cells_en = [
  { title: "Search", lines: [
    ...
    { text: "Metro ........ S/ 3.90", color: "text-[#27c93f]", delay: 1000 },
    { text: "Plaza Vea ..... S/ 4.50", color: "text-[#27c93f]", delay: 1200 },
    { text: "▸ 3 results in 1.2s", color: "text-[#454745]", delay: 1500 },
  ]},
  { title: "Compare", lines: [
    ...
    { text: "▸ Savings: S/ 0.70 per unit", color: "text-[#454745]", delay: 1300 },
  ]},
  { title: "Cart", lines: [
    { text: "$ market basket milk:2 rice:1", delay: 300 },
    { text: "▸ Basket compared in 3 stores", color: "text-[#454745]", delay: 600 },
    { text: "Metro ....... S/ 11.70 total", color: "text-[#27c93f]", delay: 900 },
    { text: "Wong ........ S/ 12.30 total", color: "text-[#ffbd2e]", delay: 1100 },
    { text: "Plaza Vea ... S/ 13.20 total", color: "text-[#ffbd2e]", delay: 1300 },
  ]},
  { title: "Checkout", lines: [
    ...
    { text: "▸ Yape QR generated", color: "text-[#454745]", delay: 900 },
    { text: "▸ Scan to complete payment", color: "text-[#454745]", delay: 1100 },
  ]},
];
  ...
  return (
    <div ref={ref} className="bg-[#e8ebe6] border border-[#c5edab] rounded-lg p-4 min-h-[140px]">
      <div className="flex items-center gap-1.5 mb-3 pb-2 border-b border-[#fafafa]">
        ...
        <span className="text-[10px] text-[#454745] font-mono ml-2 uppercase tracking-wider">{title}</span>
      </div>
  ...
  return (
    <section id="terminal" className="relative bg-[#e8ebe6] py-20 border-t border-[#c5edab]">
      <div className="max-w-[720px] mx-auto px-6 text-center">
        <p className="text-xs text-[#454745] font-mono uppercase tracking-[0.15em] mb-8">{_t("terminal_label")}</p>
        ...
        <p className="mt-8 text-[10px] text-[#454745] font-mono uppercase tracking-[0.15em]">{_t("terminal_footer")}</p>
      </div>
    </section>
  );
}
