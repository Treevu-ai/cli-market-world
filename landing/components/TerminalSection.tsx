...
const steps = [
  { cmd: "pip install git+https://github.com/Treevu-ai/cli-market-world.git", color: "#00FF88", output: "→ Instalá el CLI en tu sistema", outColor: "#444" },
  { cmd: "market-server &", color: "#00FF88", output: "→ Levantá el backend en localhost:8765", outColor: "#444" },
  { cmd: "market login", color: "#00FF88", output: "→ Autenticate para acceder a 3,400+ retailers", outColor: "#444" },
  ...
  { cmd: "market add 1 --qty 2", color: "#F5F5F0", output: "→ Agregá al carrito desde el resultado de búsqueda", outColor: "#444" },
  { cmd: "market checkout --payment yape", color: "#F5F5F0", output: "→ Completá la compra con métodos de pago locales", outColor: "#444" },
];
  ...
  return (
    <section ref={ref} id="terminal" className="relative flex flex-col w-full bg-black py-16 px-6 lg:px-12 md:py-[80px] gap-10">
      <div className="flex flex-col gap-3 max-w-[600px]">
        ...
        <p className="text-white/50 font-mono text-sm leading-relaxed">Instalá, autenticate y empezá a buscar en 3,400+ retailers VTEX desde la terminal.</p>
      </div>
