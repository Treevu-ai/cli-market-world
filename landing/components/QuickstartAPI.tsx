        ...
        <div className="text-left space-y-4 max-w-[560px] mx-auto">
          <div className="bg-[var(--wise-green-pale)] border border-[#c5edab] rounded-lg p-4 font-mono text-[11px] leading-relaxed">
            <div className="flex items-center gap-1.5 mb-3 pb-2 border-b border-[#c5edab]">
              ...
              <span className="text-[10px] text-[var(--wise-body)] ml-2 uppercase">POST /v1/search</span>
            </div>
            <pre className="text-[var(--wise-body)] whitespace-pre-wrap">{`Content-Type: application/json
  ...
  "limit": 5
          ...
          <div className="bg-[var(--wise-green-pale)] border border-[#c5edab] rounded-lg p-4 font-mono text-[11px] leading-relaxed">
            <div className="flex items-center gap-1.5 mb-3 pb-2 border-b border-[#c5edab]">
              ...
              <span className="text-[10px] text-[var(--wise-body)] ml-1 uppercase">200 OK</span>
            </div>
