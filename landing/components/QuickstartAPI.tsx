...
export default function QuickstartAPI() {
  ...
  return (
    <section id="api" className="relative bg-white py-20 border-t border-[#e5e5e5]">
      <div className="max-w-[720px] mx-auto px-6 text-center">
        <p className="text-xs text-[#a3a3a3] font-mono uppercase tracking-[0.15em] mb-8">API</p>
        ...
        <div className="text-left space-y-4 max-w-[560px] mx-auto">
          <div className="bg-[#fafafa] border border-[#e5e5e5] rounded-lg p-4 font-mono text-[11px] leading-relaxed">
            <div className="flex items-center gap-1.5 mb-3 pb-2 border-b border-[#e5e5e5]">
              ...
              <span className="text-[10px] text-[#a3a3a3] ml-2 uppercase">POST /v1/search</span>
            </div>
            <pre className="text-[#525252] whitespace-pre-wrap">{`Content-Type: application/json
...

{
  ...
  "limit": 5
          ...
          <div className="bg-[#fafafa] border border-[#e5e5e5] rounded-lg p-4 font-mono text-[11px] leading-relaxed">
            <div className="flex items-center gap-1.5 mb-3 pb-2 border-b border-[#e5e5e5]">
              ...
              <span className="text-[10px] text-[#a3a3a3] ml-1 uppercase">200 OK</span>
            </div>
            <pre className="text-[#525252] whitespace-pre-wrap">{`{
  "results": [{
    "retailer": "Metro",
    "price": 3.90,
    "currency": "PEN",
  ...
  "generated_at": "2026-05-25T12:00:00Z"
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-x-6 gap-y-2 text-xs text-[#737373]">
