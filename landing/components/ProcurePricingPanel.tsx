    ...
    <div className="scroll-mt-24 text-left">
      <div className="landing-content-narrow mb-10 space-y-4 text-center">
        <div className="rounded-xl border border-[var(--cm-outline-variant)]/35 bg-[var(--cm-surface-low)]/40 px-4 py-3 text-left text-xs text-[var(--cm-on-surface-variant)] leading-relaxed">
          ...
          <p>
            {isES
              ? "Build Pro ($39) es para quien integra la API en código. Procure Pro ($79) es para equipos de compras (aprobaciones, checkout retail) — incluye la API; no pagues los dos salvo que quieras ambos dashboards."
              : "Build Pro ($39) is for developers integrating the API. Procure Pro ($79) is for procurement teams (approvals, retail checkout) — API included; only pay both if you need both dashboards."}
          </p>
        </div>
      </div>
