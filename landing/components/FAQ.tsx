...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "ACTUALMENTE CON 8 SUPERMERCADOS EN 5 PAÍSES: WONG, METRO Y PLAZA VEA (PERÚ); CARREFOUR Y JUMBO (ARGENTINA); CARREFOUR (BRASIL); CHEDRAUI Y HEB (MÉXICO); OLÍMPICA (COLOMBIA). ADEMÁS, ACCEDE A MÁS DE 3 MILLONES DE PRODUCTOS GLOBALES CON OPEN FOOD FACTS.",
  },
  {
    question: "¿Cómo se integra con agentes de IA?",
    answer:
      "EL PROYECTO INCLUYE UN SERVIDOR MCP CON 9 HERRAMIENTAS LISTAS PARA USAR: MARKET_LOGIN, MARKET_SEARCH, MARKET_COMPARE, MARKET_ADD, MARKET_CART, MARKET_CHECKOUT, MARKET_ORDERS, MARKET_REORDER Y MARKET_ASK. COMPATIBLE CON DEEPSEEK, CLAUDE Y CUALQUIER CLIENTE MCP.",
  },
  {
