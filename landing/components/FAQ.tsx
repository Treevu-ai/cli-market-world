...
const faqs = [
  { question: "¿Qué es CLI Market?", answer: "Es una capa de infraestructura que convierte 500+ comercios VTEX en 31 países y 12 líneas de negocio en sistemas compatibles con agentes de inteligencia artificial. Stripe convirtió los pagos en APIs; nosotros convertimos el comercio en APIs.", defaultOpen: true },
  { question: "¿Con qué comercios funciona?", answer: "Con 500+ comercios en 12 líneas: supermercados (Wong, Metro, Plaza Vea, Carrefour, Jumbo, Coto, Dia, Pão de Açúcar, Chedraui, HEB, Olímpica, Éxito, Lider, Soriana), farmacias (Droga Raia, Drogasil, Inkafarma, Farmatodo), electro (Magazine Luiza, Samsung, Motorola, LG, Alkosto, Frávega), moda (Renner, C&A, Marisa, Riachuelo, Arturo Calle, Leonisa), deportes (Centauro, Nike, Adidas, Decathlon en 10 países), hogar (Homecenter, Sodimac, Easy, Promart, Leroy Merlin) y más." },
