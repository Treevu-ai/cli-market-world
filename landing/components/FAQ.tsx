...
const faqs = [
  { question: "¿Qué es CLI Market?", answer: "Es una capa de infraestructura que convierte 100 comercios VTEX en 12 países y 12 líneas de negocio en sistemas compatibles con agentes de inteligencia artificial. Stripe convirtió los pagos en APIs; nosotros convertimos el comercio en APIs.", defaultOpen: true },
  { question: "¿Con qué comercios funciona?", answer: "Con 100 comercios en 12 líneas: supermercados (Wong, Metro, Plaza Vea, Carrefour, Jumbo, Coto, Dia, Pão de Açúcar, Chedraui, HEB, Olímpica, Éxito, Lider, Soriana), farmacias (Droga Raia, Drogasil, Inkafarma, Farmatodo), electro (Magazine Luiza, Samsung, Motorola, LG, Alkosto, Frávega), moda (Renner, C&A, Marisa, Riachuelo, Arturo Calle, Leonisa), deportes (Centauro, Nike, Adidas, Decathlon en 10 países), hogar (Homecenter, Sodimac, Easy, Promart, Leroy Merlin) y más." },
  ...
  { question: "¿Cómo se manejan los pagos?", answer: "El checkout soporta métodos de pago locales como Yape (Perú). Las credenciales se almacenan localmente. El sistema está diseñado para que los agentes de IA compren de forma autónoma pero segura, con confirmación explícita en cada operación. Las contraseñas usan PBKDF2 con salt." },
