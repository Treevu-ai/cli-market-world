...
const faqs_es = [
  { q: "¿Qué es CLI Market?", a: "CLI Market es una API y CLI que permite a agentes de IA buscar, comparar y comprar productos en 30 retailers de 7 países. 13,000+ precios reales. Una sola API. Cero scraping." },
  { q: "¿Con qué retailers funciona?", a: "Trabajamos con 30 retailers verificados en 6 líneas: supermercados, farmacias, electro, moda, hogar y departamentales. Abarcamos VTEX, Shopify y Magento en 7 países de Latinoamérica." },
...
const faqs_en = [
  { q: "What is CLI Market?", a: "CLI Market is an API and CLI that lets AI agents search, compare, and buy products across 30 retailers in 7 countries. 13,000+ real prices. One API. Zero scraping." },
  { q: "Which retailers do you support?", a: "30 verified retailers across 6 lines: supermarkets, pharmacies, electronics, fashion, home, and department stores. We cover VTEX, Shopify, and Magento in 7 countries across Latin America." },
