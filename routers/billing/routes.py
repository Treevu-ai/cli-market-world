...
async def _start_procure_mercadopago_checkout(
    ...
    *,
    ...
    mp_success = os.getenv(
        ...
        "https://procurecopilot.com/subscribe?mp=success&audience=procure&ref={ref}",
    ).replace("{ref}", request_id)
    mp_pending = os.getenv(
        "PROCURE_MP_PENDING_URL",
        "https://procurecopilot.com/subscribe?mp=pending&audience=procure&ref={ref}",
    ).replace("{ref}", request_id)
    mp_failure = os.getenv(
        "PROCURE_MP_FAILURE_URL",
        "https://procurecopilot.com/subscribe?mp=failure&audience=procure&ref={ref}",
    ).replace("{ref}", request_id)
...
async def _start_procure_subscription(
    ...
    *,
    ...
    return_url = os.getenv(
        ...
        "https://procurecopilot.com/subscribe?sub=success&audience=procure",
    )
    cancel_url = os.getenv(
        "PROCURE_SUBSCRIBE_CANCEL_URL",
        "https://procurecopilot.com/subscribe?sub=cancelled&audience=procure",
    )
