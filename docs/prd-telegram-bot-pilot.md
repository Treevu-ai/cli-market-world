...
| Canasta exploratoria | Implementada vía `/v1/basket/compare`, enriquecida con snapshot | Publicar Core 1.12.2 y validar en producción |
...
La canasta actual añade un control de cobertura. Core 1.12.2 añade
