...
| Canasta exploratoria | Implementada vía `/v1/basket/compare`, enriquecida con snapshot | Validar Core 1.12.5 en producción |
...
La canasta actual añade un control de cobertura. Core 1.12.5 incorpora
