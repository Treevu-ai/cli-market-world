...
| `LINKEDIN_CAMPAIGN_START` | `2026-05-29` | Día 1 del calendario 30d (content repo) |
| `CLI_MARKET_CONTENT_DIR` | `../cli-market-content` | Repo privado posts + assets — ver [[../CONTENT]] |
