...
|--------------|-------|-----------|
| Construye agentes o productos con API/MCP | **CLI Market Build** (Free / Starter $9 / Pro $49 / Pro Founding $29) | Procure |
...
¿Escribe código o configura MCP?
  Sí → CLI Market Build (Free · Starter $9 · Pro $49 · Pro Founding $29)
