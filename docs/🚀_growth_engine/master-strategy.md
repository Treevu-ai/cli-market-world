...
> **Documento de decisión consolidado** · v1.0 · Mayo 2026 · **Métricas canónicas (jun 2026):** `python3 ops/sync_market_stats.py` → `landing/lib/marketStats.ts` (38 verified · 22 MCP default · 54k+ prices · 4 platforms incl. WooCommerce). Pricing Build: Free / Starter $9 / Pro $49 — ver `docs/pricing-strategy.md`.
