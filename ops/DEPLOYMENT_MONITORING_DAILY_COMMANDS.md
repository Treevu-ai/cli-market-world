...
**Generado:** 2026-06-07 (actualizado después de commits de estandarización JSON/agentic)
...
7. **python market_golive.py** (o `ops/go_live_check.py`)  
...
8. **make fresh** (`python scripts/check-freshness.py`)  
   Diagnóstico de frescura del moat (cuánto tiempo desde último snapshot por retailer).

9. **make publish day=N** (`python scripts/mark-published.py --day N`)  
