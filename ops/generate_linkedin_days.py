...
8,000+ precios indexados. 28 retailers activos hoy. 21 países.
...
→ 30 retailers verificados en 21 países
...
Pero sí tenemos algo que casi nadie tiene para agentes de IA: **8,000+ precios de góndola actualizados cada 8 horas** en 21 países.
...
30 retailers. 22 herramientas MCP. 21 países. Open source.
...
¿Cuál insight te sorprende más?""",
    ...
    15: {
        ...
        "lang": "es",
        "hooks": [
            "Arranqué CLI Market con un solo conector VTEX. Hoy son 30 retailers en 21 países.",
...
→ 21 países (PE, AR, BR, MX, CO, CL, IT, FR)
→ 22 herramientas MCP
...
30 retailers. 21 countries. 22 MCP tools. Open source.
...
¿Qué construirías encima de esta API?""",
    ...
    28: {
        ...
        "lang": "es",
        "hooks": [
            "30 días. 30 retailers. 21 países. 22 MCP tools. Recap.",
