...
8,000+ precios indexados. 28 retailers activos hoy. 9 países.
...
→ 30 retailers verificados en 9 países
...
Pero sí tenemos algo que casi nadie tiene para agentes de IA: **8,000+ precios de góndola actualizados cada 8 horas** en 9 países.
...
30 retailers. 22 herramientas MCP. 9 países. Open source.
...
¿Cuál insight te sorprende más?""",
    ...
    15: {
        ...
        "lang": "es",
        "hooks": [
            "Arranqué CLI Market con un solo conector VTEX. Hoy son 30 retailers en 9 países.",
...
¿Qué construirías encima de esta API?""",
    ...
    28: {
        ...
        "lang": "es",
        "hooks": [
            "30 días. 30 retailers. 9 países. 22 MCP tools. Recap.",
